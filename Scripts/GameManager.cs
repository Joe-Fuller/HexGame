...
public class GameManager : Node
{
    ...
    public override void _Process(float delta)
    {
        if (Input.IsActionJustPressed("left_click") && !CombatManager.InCombat)
        {
            ...
            Tilemap.SpawnUnit(new Vector2(1, 1), true, 0);
            Tilemap.SpawnUnit(new Vector2(1, 2), true, 1);
            Tilemap.SpawnUnit(new Vector2(1, 3), true, 2);
            Tilemap.SpawnUnit(new Vector2(1, 4), true, 3);
            Tilemap.SpawnUnit(new Vector2(1, 5), true, 4);
